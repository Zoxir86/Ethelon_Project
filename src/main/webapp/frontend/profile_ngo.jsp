...
<div class="container bootstrap snippet">
    <div class="row">
        <div class="col-sm-10"><h1>Ethelon</h1></div>
        <div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="http://www.ethelon.org/wp-content/uploads/2016/12/logo.png"></a></div>
    </div>
    <div class="row">
        <div class="col-sm-3"><!--left col-->
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong>Όνομα Χρήστη</strong></span> ethelon</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Όνομα Οργανισμού</strong></span> Έθελον</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Email</strong></span> ethelon@ethelon.gr</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Ιστοσελίδα</strong></span> ethelon.org</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Χώρα</strong></span> Ελλάδα</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Διεύθυνση</strong></span> Πειραιώς 22</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Τηλέφωνο</strong></span> 69999999</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Περιγραφή Οργανισμού</strong></span>  Γεια</li>
