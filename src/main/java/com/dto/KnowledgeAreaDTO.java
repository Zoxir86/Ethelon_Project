...
public class KnowledgeAreaDTO {
    ...
    public KnowledgeAreaDTO(int databaseID, String descriptionGreekUpperCase, String descriptionEnglishUpperCase, String descriptionGreekLowerCase, String descriptionEnglishLowerCase) {
